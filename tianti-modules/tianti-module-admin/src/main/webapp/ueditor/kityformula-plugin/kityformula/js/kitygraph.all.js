 ...
 * ======================================================== */
    ...
    define("core/utils", [], function () {
        var utils = {
            ...
            extend: function (t) {
                var a = arguments, notCover = this.isBoolean(a[a.length - 1]) ? a[a.length - 1] : false,
 ...
 */
    define("filter/projectionfilter", ["filter/effect/gaussianblureffect", "filter/effect/effect", "core/utils", "core/class", "graphic/svg", "filter/effect/colormatrixeffect", "graphic/color", "graphic/standardcolor", "filter/effect/compositeeffect", "filter/effect/offseteffect", "filter/filter", "filter/effectcontainer", "graphic/shape"], function (require, exports, module) {
        var GaussianblurEffect = require("filter/effect/gaussianblureffect"), Effect = require("filter/effect/effect"),
            ColorMatrixEffect = require("filter/effect/colormatrixeffect"), Color = require("graphic/color"),
            Utils = require("core/utils"), CompositeEffect = require("filter/effect/compositeeffect"),
    ...
    define("graphic/bezierpoint", ["graphic/shapepoint", "core/class", "graphic/point", "graphic/vector", "graphic/matrix"], function (require, exports, module) {
        ...
        var BezierPoint = require("core/class").createClass("BezierPoint", {
            ...
            moveTo: function (x, y) {
                var oldForward = this.forward.getPoint(), oldBackward = this.backward.getPoint(),
            ...
            updateAnother: function (p, q) {
                var v = this.getVertex(), pv = Vector.fromPoints(p.getPoint(), v),
    ...
    define("graphic/box", ["core/class"], function (require, exports, module) {
        var Box = require("core/class").createClass("Box", {
            ...
            merge: function (another) {
                var xMin = Math.min(this.x, another.x), xMax = Math.max(this.x + this.width, another.x + another.width),
    ...
    define("graphic/color", ["core/utils", "graphic/standardcolor", "core/class"], function (require, exports, module) {
        var Utils = require("core/utils"), StandardColor = require("graphic/standardcolor"), ColorUtils = {},
 ...
 * */
    define("graphic/curve", ["core/utils", "core/class", "graphic/path", "graphic/shape", "graphic/svg", "graphic/geometry", "graphic/pointcontainer", "graphic/container"], function (require, exports, module) {
        ...
        return require("core/class").createClass("Curve", {
            ...
            update: function () {
                var points = this.getPoints(), withControlPoints = null, drawer = this.getDrawer(), curPoint = null,
                    curControlPoint = null, prevControlPoint = null;
                drawer.clear();
                if (points.length === 0) {
                    return this;
                } else {
 ...
 */
    ...
    define("graphic/geometry", ["core/utils", "graphic/point", "core/class", "graphic/vector", "graphic/matrix", "graphic/box"], function (require) {
        ...
        var pathCommand = /([achlmrqstvz])[\s,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\s]*,?\s*)+)/gi,
            pathValues = /(-?\d*\.?\d*(?:e[\-+]?\d+)?)\s*,?\s*/gi, paramCounts = {
                a: 7,
                c: 6,
                h: 1,
                l: 2,
        ...
        function cacher(f, scope, postprocessor) {
            ...
            function newf() {
                var arg = Array.prototype.slice.call(arguments, 0), args = arg.join("␀"),
        ...
        function a2c(x1, y1, rx, ry, angle, laf, sf, x2, y2, recursive) {
            ...
            var math = Math, PI = math.PI, abs = Math.abs, _120 = PI * 120 / 180, rad = PI / 180 * (+angle || 0),
                res = [], xy, rotate = function (x, y, rad) {
            ...
            var cos, sin, h, x, y, rx2, ry2, k, cx, cy, f1, f2, df, f2old, x2old, y2old, c1, s1, c2, s2, t, hx, hy, m1,
                m2, m3, m4, newres, i, ii;
            if (!recursive) {
                xy = rotate(x1, y1, -rad);
                x1 = xy.x;
                y1 = xy.y;
        ...
        function cutBezier(bezierArray, t) {
            ...
            var _ = __(t || .5), ba = bezierArray, ax = ba[0], ay = ba[1], bx = ba[2], by = ba[3], cx = ba[4],
                cy = ba[5], dx = ba[6], dy = ba[7], ex = _(ax, bx), ey = _(ay, by), fx = _(bx, cx), fy = _(by, cy),
                gx = _(cx, dx), gy = _(cy, dy), hx = _(ex, fx), hy = _(ey, fy), jx = _(fx, gx), jy = _(fy, gy),
                kx = _(hx, jx), ky = _(hy, jy);
    ...
    define("graphic/palette", ["graphic/standardcolor", "graphic/color", "core/utils", "core/class"], function (require, exports, module) {
        //标准color
        var StandardColor = require("graphic/standardcolor"), Color = require("graphic/color"),
        ...
        return require("core/class").createClass("ShapeEvent", {
            ...
            getPosition: function (refer, touchIndex) {
                ...
                var clientX = eventClient && eventClient.clientX || 0,
                    ...
                    node = this.targetShape.shapeNode || this.targetShape.node, // 鼠标位置在目标对象上的坐标
                    // 基于屏幕坐标算
        ...
        return require("core/class").createClass("Star", {
            ...
            draw: function () {
                var innerRadius = this.radius,
                    ...
                    vertex = this.vertex, offset = this.offset, angleStart = 90, angleStep = 180 / vertex,
                    angleOffset = this.angleOffset, drawer = this.getDrawer(), i, angle;
                drawer.clear();
        ...
        return require("core/class").createClass("Sweep", {
            ...
            drawSection: function (from, to) {
                var angleLength = this.angle && (this.angle % 360 ? this.angle % 360 : 360),
                    angleStart = this.angleOffset, angleHalf = angleStart + angleLength / 2,
                    angleEnd = angleStart + angleLength, drawer = this.getDrawer();
                drawer.redraw();
                if (angleLength === 0) {
                    drawer.done();
                    return;
