        ...
        <form action="${ctx }/user/list" id="queryForm" method="post">
            <div class="J_toolsBar clearfix">
                ...
                <div class="t_text ml10">
                    <input placeholder="请输入账号" type="text" name="userName" id="userName"
                           value="${userQueryDTO.userName }"/>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="t_link">
                                                ...
                                                <c:choose>
                                                    <c:when test="${u.status eq '1' }">
                                                        <a href="javascript:updStatus('${u.id }', '0');"><i
                                                                class="icon"></i>删除</a>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <a href="javascript:updStatus('${u.id }', '1');"><i
                                                                class="icon"></i>恢复</a>
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
