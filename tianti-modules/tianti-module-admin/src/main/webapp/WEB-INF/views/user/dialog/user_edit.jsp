                                    ...
                                    <label>
                                        <c:choose>
                                            <c:when test="${not empty user }">
                                                <input type="text" name="username" data-rule="账号:required;"
                            ...
                            <div class="J_toolsBar fl">
                                <div class="t_text w200 ml10">
                                    <label>
                                        <c:choose>
                                            <c:when test="${not empty user }">
                                                <input type="password" placeholder="修改时输入" name="password"
                                                       data-rule="密码:password;" value=""/>
                                            </c:when>
                                            <c:otherwise>
                                                <input type="password" name="password" data-rule="密码:required;password;"
                                                       value=""/>
                                            </c:otherwise>
                                        </c:choose>
                                    </label>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="J_toolsBar fl">
                                <div class="t_text w200 ml10">
                                    <label>
                                        <input type="text" name="realName" data-rule="真实姓名:length[~20];"
                                               value="${user.realName }"/>
                                    </label>
                                </div>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="J_toolsBar fl">
                                <div class="t_text w200 ml10">
                                    <label>
                                        <input type="text" name="mobile" data-rule="手机号码:mobile;"
                                               value="${user.mobile }"/>
                                    </label>
                                </div>
                            </div>
                        ...
                        <td>
                            <div class="J_toolsBar fl">
                                <div class="t_label ml10" style="width: 220px;">
                                    <select data-placeholder="选择权限" multiple class="chosen-select" name="roleId"
                                            data-rule="权限:required;">
