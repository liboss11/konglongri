    ...
    <div class="h_left">
        <div class="l_nav">
            ...
            <div class="n_item
                ...
                ">
                <div class="i_default"><a
                        href="${ctx }/cms/article/list?type=zhiding&rootColumnId=${articleQueryDTO.rootColumnId}"><span>置顶文章（
                     <c:choose>
            ...
            <div class="n_item
                ...
                ">
                <div class="i_default"><a
                        href="${ctx }/cms/article/list?rootColumnId=${articleQueryDTO.rootColumnId}"><span>审核列表（
                    <c:choose>
            ...
            <div class="n_item
                ...
                ">
                <div class="i_default"><a
                        href="${ctx }/cms/article/list?type=laji&rootColumnId=${articleQueryDTO.rootColumnId}"><span>垃圾箱（
                    <c:choose>
    ...
    <div class="mt20 plr20">
        <form action="${ctx }/cms/article/list" id="queryForm" method="POST">
            ...
            <div class="J_toolsBar clearfix">
                ...
                <div class="t_text ml10">
                    <input placeholder="开始时间" type="text" id="startDate" name="startDate"
                           onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="${articleQueryDTO.startDate }">
                </div>
                <div class="t_text ml10">
                    <input placeholder="结束时间" type="text" id="endDate" name="endDate"
                           onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="${articleQueryDTO.endDate }">
                </div>
            ...
            <div style="text-align: right; line-height: 40px; font-size: 12px; color: red;">
                文章只有审核通过且未删除才能在前端显示，如果设置为置顶则在该模块优先显示。
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="t_link">
                                                ...
                                                <c:choose>
                                                    <c:when test="${p.deleteFlag eq '0' }">
                                                        <a href="javascript:updDeleteFlag('${p.id }', '1');"><i
                                                                class="icon"></i>删除</a>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <a href="javascript:updDeleteFlag('${p.id }', '0');"><i
                                                                class="icon"></i>恢复</a>
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
