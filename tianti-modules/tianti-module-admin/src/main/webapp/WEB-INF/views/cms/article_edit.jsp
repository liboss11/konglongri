        ...
        <div class="J_formTable l_form_table mgt40">
            <form action="${ctx}/cms/article/ajax/save" id="editForm" method="post">
                ...
                <table>
                        ...
                        <td>
                            <div class="J_toolsBar fl">
                                <div class="t_opacitySelect ml10">
                                    <span>请选择</span>
                                    <select id="rootColumnId" name="rootColumnId" onChange="selectLeafColumn()"
                    ...
                    <tr>
                        <td class="l_title w200">图片：<a href="${ctx }/cms/article/flashView" target="_blank"><font
                                ...
                                <div class="t_img w100 ml10">
                                    <c:choose>
                                        <c:when test="${article.coverImageUrl != null && article.coverImageUrl != ''}">
                                            <img src="${ctx }${article.coverImageUrl}" id="attachURL" width="100px"
                                                 height="100px"/>
                                        </c:when>
                                        <c:otherwise>
                                            <img src="${ctx }/static/images/J_null.png" id="attachURL" width="100px"
                                                 height="100px"/>
                                        </c:otherwise>
                                    </c:choose>
