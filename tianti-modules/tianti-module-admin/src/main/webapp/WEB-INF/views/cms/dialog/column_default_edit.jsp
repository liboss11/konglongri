                                        ...
                                        <c:choose>
                                            <c:when test="${columnInfo == null  }">
                                                <input type="text" name="code" maxlength="20"
                                                       data-rule="栏目编码:required;code;remote[${ctx }/cms/column/ajax/validator/code]"
                                                       value="${columnInfo.code }"/>
                                            </c:when>
                                            <c:otherwise>
                                                <input type="text" name="code" maxlength="20" readonly="readonly"
                                                       value="${columnInfo.code }"/>
                                            </c:otherwise>
                                        </c:choose>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="J_toolsBar fl">
                                <div class="t_text w200 ml10">
                                    <label>
                                        <input type="text" name="orderNo" maxlength="50" value="${columnInfo.orderNo }"
                                               maxlength="200"/>
                                    </label>
                                </div>
                            </div>
