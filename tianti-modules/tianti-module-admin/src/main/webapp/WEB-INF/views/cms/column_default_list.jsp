                    ...
                    <div class="J_filterGroup">
                        ...
                        <div class="f_main">
                            ...
                            <div class="m_btn" style="display: none;">
                                ...
                                <a href="javascript:delColumn('${columnInfoQueryDTO.rootColumnId }');"><i
                                        class="icon"></i><span>删除</span></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function myQrcode(id) {
        var title = '栏目置顶文章的二维码';
        layer.open({
            title: title,
            type: 1,
            area: ['400px', '440px'],
            content: '<div id="qrcodeCanvas" style="text-align: center;margin:30px 30px 30px 30px;"></div>',
            btn: ['确定', '取消'],
            yes: function (index, layero) {
                mySubmit();
            },
