...
<div data-ui="header" class="J_header">
    ...
    <div class="h_right">
        <div class="r_menu">
            <div class="m_item">
                <div class="i_default"><a href="javascript:;"><i
                        class="icon user"></i><span>${sessionScope.session_login_user.realName }</span><i
                        class="icon down"></i></a></div>
                <div class="i_menu">
                    <div data-ui="profile" class="J_profile">
                        ...
                        <div class="p_list">
                            <div class="l_item"><a href="${ctx }/user/update_pwd"><i class="icon"></i><span>修改密码</span></a>
                            </div>
                            <div class="l_item border"><a href="${ctx }/login_out"><i class="icon"></i><span>退出</span></a>
                            </div>
                        </div>
                    </div>
                </div>
