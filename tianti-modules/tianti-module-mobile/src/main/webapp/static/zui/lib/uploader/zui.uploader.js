    ...
    !function (e, t) {
        ...
        n("moxie/core/utils/Basic", [], function () {
                ...
                n = {
                    mimes: {}, extensions: {}, addMimeType: function (e) {
                        ...
                        for (r = 0; r < t.length; r++) for (n = t[r].extensions.split(/\s*,\s*/), o = 0; o < n.length; o++) {
                            if ("*" === n[o]) return [];
                            if (a = s.mimes[n[o]], a && -1 === e.inArray(a, u) && u.push(a), i && /^\w+$/.test(n[o])) u.push("." + n[o]); else if (!a) return []
                        }
                        return u
            ...
            var e = function (t, i) {
                ...
                var i = {http: 80, https: 443}, n = "object" == typeof t ? t : e(t);
            ...
            function c() {
                ...
                t.extend(this, {
                    loadFromBlob: function (e) {
                        ...
                        })) : new o(null, {name: w.name || "", type: e, data: E.getAsBinaryString(e, t)})
                        ...
                        if ("image/jpeg" !== e) y = l(E.getAsDataURL(e, t)); else {
                            var i;
                            t || (t = 90), c();
                            try {
        ...
        l.addFileFilter("mime_types", function (e, t, i) {
            ...
            function _(e, i, r) {
                function s(e, i, n) {
                    ...
                    switch (e) {
                        ...
                        case"unique_names":
                            ...
                            break;
                        case"filters":
                            "array" === l.typeOf(i) && (i = {mime_types: i}), n ? l.extend(I.filters, i) : I.filters = i, i.mime_types && ("string" === l.typeOf(i.mime_types) && (i.mime_types = t.core.utils.Mime.mimes2extList(i.mime_types)), i.mime_types.regexp = function (e) {
                                var t = [];
                            ...
                            break;
                        case"resize":
                            I.resize = i ? l.extend({preserve_headers: !0, crop: !1}, i) : !1;
                            break;
                ...
                "object" == typeof e ? l.each(e, function (e, t) {
                    s(t, e, r)
                }) : s(e, i, r), r ? (I.required_features = n(l.extend({}, I)), F = n(l.extend({}, I, {required_features: !0}))) : u && (a.trigger("Destroy"), g.call(a, I, function (e) {
            ...
            I = {
                ...
                getFile: function (e) {
                    var t;
                    for (t = T.length - 1; t >= 0; t--) if (T[t].id === e) return T[t]
                },
                ...
                removeFile: function (e) {
                    for (var t = "string" == typeof e ? e : e.id, i = T.length - 1; i >= 0; i--) if (T[i].id === t) return this.splice(i, 1)[0]
                },
                splice: function (e, t) {
        ...
        var eventHandlers = {
            ...
            FileUploaded: function (uploader, file, responseObject) {
                if (responseObject) {
                    ...
                    try {
                        file.remoteData = $.parseJSON(responseData);
                    }
                    catch (e) {
                    }
                }
